...
if IS_SIM:
    ...
    from my_robot_env import CustomEnv, AVAILABLE_SIM_NAMES, AVAILABLE_CAM_NAMES
...
def my_main(args):
    ...
    if TASK_NAME == 'stack':
        ...
        print("no json file for this task")
        raise Exception
    ...
    if IS_SIM:
        ...
        env = CustomEnv(task_name=TASK_NAME, inject_noise=INJECT_NOISE, random_start=True)
